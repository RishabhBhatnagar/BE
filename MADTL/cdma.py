...
class User:
     def __init__(self, code):
          # code is a list of 1 and -1.
          # All the users has same number of bits in the code.
...
"""
OUTPUT:
Enter the data of the four stations: 48 17 50 87
Enter the channel you want to listen to[0-4]: 3
87 is the data.
"""
